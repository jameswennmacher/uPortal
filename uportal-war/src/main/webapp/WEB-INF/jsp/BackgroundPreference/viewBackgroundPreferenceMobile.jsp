...
<div id="${n}jasigBackgroundPreferencePortlet" class="jasigBackgroundPreference ui-helper-hidden">
    ...
    <form id="${n}addLocationForm" class="select-location-form" action="${savePreferencesUrl}" method="post">
        <label for="backgroundImage">Preferred Background Image</label>
...
<script type="text/javascript">
	up.jQuery(function() {
    	...
    	$('${overlayImageOn}').css({'background-image': 'url("${backgroundImage}")', 'background-size':'cover'});
    	$('${applyOpacityTo}').css({'opacity': '${opacityCssValue}'});
	});
</script>
